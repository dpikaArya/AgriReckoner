...
from agri_ai_agent.agents.ready_reckoner_agent import ReadyReckonerAgent, RECOMMENDATION_COLS
...
def sample_df():
    return pd.DataFrame({
        ...
        "Recommendation_Summary": ["Apply Urea 150 kg/ha", "Apply DAP 120 kg/ha", "Apply 15-15-15 100 kg/ha"],
    })
