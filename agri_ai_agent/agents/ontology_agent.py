...
class OntologyAgent(BaseAgent):
    ...
    def _resolve_column(self, col_name: str) -> str | None:
    ...
    def _guess_canonical(self, col_name: str, df: pd.DataFrame) -> str | None:
        normalized = self._normalize_name(col_name)
    ...
    def resolve_value(self, value: str, unit_type: str = "general") -> float | None:
        if value is None:
            return None
        s = str(value).strip()
