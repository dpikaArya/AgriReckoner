...
class SyncManager:
    ...
    def download_resumable(self, url: str, target_path: Path,
    ...
    def skip_if_unchanged(self, source: str, resource_id: str,
                          version: str, checksum: str) -> bool:
    ...
    def cache_path(self, base_cache: Path, source: str,
                   resource_id: str, version: str) -> Path:
        cache_dir = base_cache / source / resource_id / f"v{version}"
        cache_dir.mkdir(parents=True, exist_ok=True)
        return cache_dir

    def cache_hit(self, base_cache: Path, source: str,
                  resource_id: str, version: str,
                  checksum: str) -> Optional[Path]:
